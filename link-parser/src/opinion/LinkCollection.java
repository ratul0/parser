...
public class LinkCollection {
    ...
    public static void main(String[] args) {
        ...
        try {
            Connection connection = OpinionConnect.CreateConntection();
            try {
                Statement stmtement = OpinionConnect.CreateStatement(connection);

                while (flag) {

                    try {
                        dataLinks = Onepage.getLinks("http://www.prothom-alo.com/opinion", "" + i);
                    ...
                    for (String link : dataLinks) {
                        try {
                            OpinionConnect.insertData(stmtement, link);
                            connection.commit();
